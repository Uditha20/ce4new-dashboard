...
import { Box, Button, Dialog, DialogTitle, DialogContent, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, useTheme } from '@mui/material';
          ...
          <Table>
            <TableHead>
              <TableRow>
                ...
                <TableCell>Total Delivery Cost</TableCell>
            ...
            <TableBody>
              {data?.map((order) => (
                <TableRow key={order._id}>
                  ...
                  <TableCell>${Number(order.totalDeliveryCost).toFixed(2)}</TableCell>
