...
function OrderHistory() {
  ...
  const [userFilter, setUserFilter] = useState("all"); // Default value
  ...
  const filteredOrders = data?.filter((order) => {
    ...
    if (userFilter === "reseller") return order.user?.role === "reseller";
    if (userFilter === "guest") return !order.user;
    return true;
  });
       ...
       <Box mb={2}>
        <FormControl variant="outlined" style={{ minWidth: 200 }}>
          ...
          >
            ...
            <MenuItem value="reseller">Reseller Orders</MenuItem>
            <MenuItem value="guest">Guest Orders</MenuItem>
          </Select>
        </FormControl>
      </Box>
      <TableContainer
        component={Paper}
        style={{ backgroundColor: "#21295c", overflow: "auto" }}
      >
